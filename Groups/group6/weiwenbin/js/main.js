function Weather(){
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            $(".weather-wrap").text("hi，今天" + txt.results[0].currentCity + "实时气温：" + txt.results[0].weather_data[0].temperature + "，" + txt.results[0].index[i].des + "pm2.5指数：" + txt.results[0].pm25);
        },
        error: function(){
            $(".weather-wrap").text("something is wrong");
        }
    })
}
Weather();
...
mountain.prototype.bind = function ($node){
    var _this = this
